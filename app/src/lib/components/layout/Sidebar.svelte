...
<script lang="ts">
	...
	let { side = 'left', sidebarWidth = '250px', gap = 'md', sidebar, children }: Props = $props();
</script>
...
<style>
	...
	.sidebar-layout[data-gap='xs'] {
		gap: var(--space-xs);
	}
	.sidebar-layout[data-gap='sm'] {
		gap: var(--space-sm);
	}
	.sidebar-layout[data-gap='md'] {
		gap: var(--space-md);
	}
	.sidebar-layout[data-gap='lg'] {
		gap: var(--space-lg);
	}
	.sidebar-layout[data-gap='xl'] {
		gap: var(--space-xl);
	}
