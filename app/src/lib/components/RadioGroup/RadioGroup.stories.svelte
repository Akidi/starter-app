<script module lang="ts">
	...
	import RadioGroupContainer from './RadioGroupContainer.svelte';

	/**
	 * RadioGroup component for mutually exclusive selections.
	 * Should be used within a RadioGroupContainer for proper grouping.
	 */
...
<Story name="Basic">
	{#snippet template()}
		<RadioGroupContainer legend="Choose an option">
			<RadioGroup
				id="option1"
				name="basic"
				label="Option 1"
...
<Story name="With Disabled Option">
	{#snippet template()}
		<RadioGroupContainer legend="Plan Selection">
			<RadioGroup
				id="basic"
				name="tier"
