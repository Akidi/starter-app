	...
	{#snippet template()}
		<div style="max-width: 320px;">
			<Card padding="none" hoverable>
				<div
					style="aspect-ratio: 16/9; background: #f3f4f6; display: flex; align-items: center; justify-content: center; color: #9ca3af;"
				>
					Product Image
				</div>
		...
		>
			...
			<Card>
				<div>
					...
					<p style="font-size: 0.75rem; color: #dc2626; margin-top: 0.25rem;">
						↓ 3% from last month
					</p>
				</div>
			</Card>
				...
				<Card>
					{#snippet header()}
						<div style="display: flex; gap: 1rem; align-items: center;">
							<div
								style="width: 3rem; height: 3rem; border-radius: 9999px; background: #3b82f6; color: white; display: flex; align-items: center; justify-content: center; font-weight: 600;"
							>
								JD
							</div>
							<div>
				...
				<Card title="Recent Activity" subtitle="Last 7 days">
					<div style="display: flex; flex-direction: column; gap: 1rem;">
						<div style="display: flex; gap: 1rem;">
							<div
								style="width: 2rem; height: 2rem; border-radius: 9999px; background: #dbeafe; display: flex; align-items: center; justify-content: center; flex-shrink: 0;"
							>
								<svg
						...
						<div style="display: flex; gap: 1rem;">
							<div
								style="width: 2rem; height: 2rem; border-radius: 9999px; background: #dcfce7; display: flex; align-items: center; justify-content: center; flex-shrink: 0;"
							>
								<svg
							...
							<div style="flex: 1;">
								...
								<p style="font-size: 0.75rem; color: #6b7280;">
									Stock levels adjusted - 5 hours ago
								</p>
							</div>
						</div>
						<div style="display: flex; gap: 1rem;">
							<div
								style="width: 2rem; height: 2rem; border-radius: 9999px; background: #fef3c7; display: flex; align-items: center; justify-content: center; flex-shrink: 0;"
							>
								<svg
