...
<Story name="Basic">
	{#snippet template()}
		...
		<Modal isOpen={isOpen1} onClose={() => (isOpen1 = false)} title="Basic Modal">
...
<Story name="With Footer">
	{#snippet template()}
		...
		>
			...
			{#snippet footer()}
				<Button variant="secondary" onclick={() => (isOpen3 = false)}>Cancel</Button>
				<Button variant="danger" onclick={() => (isOpen3 = false)}>Delete</Button>
			{/snippet}
		</Modal>
	{/snippet}
</Story>
		...
		>
			...
			>
				<div style="display: flex; flex-direction: column; gap: 1rem;">
					<TextInput id="product-name" name="productName" label="Product Name" required />
					<TextInput id="sku" name="sku" label="SKU" />
				</div>
			</form>

			{#snippet footer()}
				<Button variant="secondary" onclick={() => (isOpen4 = false)}>Cancel</Button>
				<Button variant="primary" onclick={() => (isOpen4 = false)}>Save Product</Button>
			{/snippet}
		</Modal>
	{/snippet}
</Story>
...
<Story name="Small Modal">
	{#snippet template()}
		...
		<Modal isOpen={isOpen1} onClose={() => (isOpen1 = false)} title="Small Modal" maxWidth="sm">
...
<Story name="Large Modal">
	{#snippet template()}
		...
		<Modal isOpen={isOpen1} onClose={() => (isOpen1 = false)} title="Large Modal" maxWidth="2xl">
