...
<Story name="Top" args={{ content: 'This is a tooltip', position: 'top' }}>
	{#snippet template()}
		<div
			style="display: flex; justify-content: center; align-items: center; min-height: 200px; padding: 4rem;"
		>
...
<Story name="All Positions">
	{#snippet template()}
		<div
			style="display: flex; justify-content: center; align-items: center; gap: 2rem; min-height: 300px; padding: 4rem;"
		>
...
<Story name="With Icons">
	{#snippet template()}
		<div
			style="display: flex; gap: 1rem; align-items: center; justify-content: center; padding: 4rem;"
		>
			...
			<div>
				...
				<div style="display: flex; align-items: center; gap: 1rem;">
					<Tooltip content="System is online">
						<div style="display: flex; align-items: center; gap: 0.5rem;">
							<div
								style="width: 0.5rem; height: 0.5rem; border-radius: 9999px; background: #10b981;"
								role="status"
								aria-label="Online"
							></div>
					...
					<Tooltip content="Last updated 5 minutes ago">
						<div style="display: flex; align-items: center; gap: 0.5rem;">
							<div
								style="width: 0.5rem; height: 0.5rem; border-radius: 9999px; background: #f59e0b;"
								role="status"
								aria-label="Syncing"
							></div>
